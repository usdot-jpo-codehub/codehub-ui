       ...
       nodejs('node') {
          dir ('App'){
            script {
                ...
                sh 'lighthouse http://dev-codehub-external-1278179393.us-east-1.elb.amazonaws.com -GA —output html —output-path report.html --port=23333 --chrome-flags="--headless" --hostname="0.0.0.0"'
