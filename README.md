...
## Changelog
Changes are in reference with the previous version (1.1)

- Changes related to data structure
- Introduction of usage of USWDS (SASS)
- Consolidation of styles between pages
- Reorganization of controls in Project Details page.
- Display DataHub related information in Project Details page.
