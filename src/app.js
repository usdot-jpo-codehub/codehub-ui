...
export class App {
  configureRouter(config, router) {
    ...
    config.map([
      ...
      { route: 'repopublishing', name: 'repopublishing', viewPorts: { mainContent: { moduleId: 'repopublishing/repopublishing'}, headerContent: { moduleId: 'components/headers/generic-title'}}, nav: true, title: 'Resources', settings:{desc: '', isTopLevelMenu_hasChildren: false, child: true, topLevelMenu_parentName: 'Resources', firstchild: true, menuitemLabel: 'Repository Registration', headerLabel: 'Site Resources', displayheader: true}},
      { route: 'metrics', name: 'metrics', viewPorts: { mainContent: { moduleId: 'metrics/metrics'}, headerContent: { moduleId: 'components/headers/generic-title'}}, nav: true, title: 'Resources', settings: { desc: '', child: true, topLevelMenu_parentName: 'Resources', firstchild: false, menuitemLabel: 'Metrics' }},
