...
export class App {
  configureRouter(config, router) {
    ...
    config.map([
      ...
      { route: 'profile', name: 'profile', viewPorts: { mainContent: { moduleId: PLATFORM.moduleName('profile/profile') },headerContent: { moduleId: PLATFORM.moduleName('components/headers/generic-title')} }, nav: false, title: 'Your Account', settings: { desc: '', isTopLevelMenu_noChildren: true }},
