export class App {
  configureRouter(config, router) {
    ...
    config.map([
      ...
      { route: 'result',      name: 'result',     moduleId: 'modules/project/popular/result', nav: false, settings:'data'},
      { route: 'result-ret',      name: 'result-ret',     moduleId: 'modules/project/popular/result-ret', nav: false},
