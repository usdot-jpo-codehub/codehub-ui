...
export class App {
  configureRouter(config, router) {
    ...
    config.map([
      ...
      { route: 'favorites', name: 'favorites', viewPorts: { mainContent: { moduleId: 'favorites/favorites' }, headerContent: { moduleId: 'components/headers/generic-title' } }, nav: true, title: 'Insight', settings: { desc: 'Software Oriented Data Analytics (SODA)' } },
