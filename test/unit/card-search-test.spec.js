...
describe('Test - Card Search : ', () => {
  ...
  it('Expect title card link text to be project name', (done) => {
    component.create(bootstrap).then( () => {
      const element = document.querySelector(`#card-search-title-link-${mockProjectData[0].id}`);
  ...
  it('Expect organization text to be the organization name', (done) => {
    component.create(bootstrap).then( () => {
      const element = document.querySelector(`#card-search-organization-link-text-${mockProjectData[0].id}`);
  ...
  it('Expect organization updated days', (done) => {
    component.create(bootstrap).then( () => {
      ...
      const element = document.querySelector(`#card-search-organization-updated-text-${mockProjectData[0].id}`);
  ...
  it('Expect organization origin text', (done) => {
    component.create(bootstrap).then( () => {
      const element = document.querySelector(`#card-search-organization-origin-text-${mockProjectData[0].id}`);
  ...
  it('Expect project number of stars', (done) => {
    component.create(bootstrap).then( () => {
      ...
      const element = document.querySelector(`#card-search-project-stars-${mockProjectData[0].id}`);
  ...
  it('Expect project number of contributors', (done) => {
    component.create(bootstrap).then( () => {
      let num = new NumValueConverter();
      const element = document.querySelector(`#card-search-project-contributors-${mockProjectData[0].id}`);
  ...
  it('Expect project number of watchers', (done) => {
    component.create(bootstrap).then( () => {
      let num = new NumValueConverter();
      const element = document.querySelector(`#card-search-project-watchers-${mockProjectData[0].id}`);
  ...
  it('Expect project number of commits', (done) => {
    component.create(bootstrap).then( () => {
      let num = new NumValueConverter();
      const element = document.querySelector(`#card-search-project-commits-${mockProjectData[0].id}`);
  ...
  it('Expect project number of releases', (done) => {
    component.create(bootstrap).then( () => {
      let num = new NumValueConverter();
      const element = document.querySelector(`#card-search-project-releases-${mockProjectData[0].id}`);
  ...
  it('Expect project number of forks', (done) => {
    component.create(bootstrap).then( () => {
      let num = new NumValueConverter();
      const element = document.querySelector(`#card-search-project-forks-${mockProjectData[0].id}`);
  ...
  it('Expect project number of dowloads', (done) => {
    component.create(bootstrap).then( () => {
      let num = new NumValueConverter();
      const element = document.querySelector(`#card-search-project-downloads-${mockProjectData[0].id}`);
      let downloads = 0;
